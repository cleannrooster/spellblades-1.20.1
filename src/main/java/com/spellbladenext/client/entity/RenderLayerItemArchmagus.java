...
public class RenderLayerItemArchmagus extends BlockAndItemGeoLayer<Archmagus> {
    public RenderLayerItemArchmagus(GeoRenderer<Archmagus> entityRendererIn) {
        super(entityRendererIn);
    }
    private static final String LEFT_HAND = "leftItem";
    private static final String RIGHT_HAND = "rightItem";
    @Override
    protected ItemStack getStackForBone(GeoBone bone, Archmagus animatable) {
    ...
    @Override
    protected ModelTransformationMode getTransformTypeForStack(GeoBone bone, ItemStack stack, Archmagus animatable) {
    ...
    @Override
    protected void renderStackForBone(MatrixStack poseStack, GeoBone bone, ItemStack stack, Archmagus animatable,
